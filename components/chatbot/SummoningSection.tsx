    ...
    >
      ...
      <div className="max-w-6xl mx-auto w-full z-20">
        ...
        <div className="relative rounded-lg border border-myth-red/70 shadow-[0_0_40px_rgba(193,18,31,0.25),0_20px_60px_rgba(0,0,0,0.95)] overflow-hidden bg-charcoal-950">
          ...
          <div className="bg-charcoal-900/95 border-b border-charcoal-800 px-3.5 py-2.5 sm:px-6 sm:py-3 flex items-center justify-between">
            {/* Left: Terminal Title with Glowing Red Dot */}
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-myth-red-bright animate-pulse shadow-[0_0_8px_rgba(255,31,45,0.8)]" />
              <span className="text-[11px] sm:text-sm font-mono font-bold tracking-[0.14em] sm:tracking-[0.18em] text-white uppercase">
            ...
            <div className="flex items-center gap-2 sm:gap-5">
              ...
              <button
                ...
                className="px-2 py-1 rounded border border-charcoal-700 bg-charcoal-950/80 hover:border-myth-red/70 hover:text-myth-red-bright text-text-muted transition-colors disabled:opacity-50 flex items-center gap-1 text-[10px] font-mono uppercase tracking-wider"
              >
                <RefreshCw className={`w-3 h-3 ${isProcessing || isThinking ? "animate-spin" : ""}`} />
                <span className="hidden sm:inline">RESET</span>
              </button>

              <div className="flex items-center gap-1 text-[10px] sm:text-[11px] font-mono font-semibold text-myth-cyan tracking-wider uppercase">
                <Lock className="w-3 h-3 text-myth-cyan" />
                <span className="hidden md:inline">SECURE CONNECTION</span>
              </div>

              {/* Dynamic Waveform */}
              <div className="hidden xs:flex items-center gap-[2px] h-3.5 sm:h-4 px-1 sm:px-1.5 py-0.5 bg-charcoal-950/80 rounded border border-charcoal-700">
                <span className="w-[2px] h-1.5 sm:h-2 bg-myth-red-bright animate-pulse" style={{ animationDelay: "0ms" }} />
                <span className="w-[2px] h-3 sm:h-3.5 bg-myth-red-bright animate-pulse" style={{ animationDelay: "150ms" }} />
                <span className="w-[2px] h-1 sm:h-1.5 bg-myth-cyan animate-pulse" style={{ animationDelay: "300ms" }} />
                <span className="w-[2px] h-3 sm:h-4 bg-myth-red-bright animate-pulse" style={{ animationDelay: "450ms" }} />
                <span className="w-[2px] h-2 sm:h-2.5 bg-myth-cyan animate-pulse" style={{ animationDelay: "200ms" }} />
                <span className="w-[2px] h-1 sm:h-1.5 bg-myth-red-bright animate-pulse" style={{ animationDelay: "100ms" }} />
              </div>

              {/* Terminal Unit ID */}
              <span className="text-[11px] sm:text-xs font-mono font-bold text-myth-red-bright tracking-widest uppercase">
                MYTH-01
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-charcoal-800">
            ...
            {/* MOBILE COMPACT HUD STRIP (< lg screens) */}
            <div className="lg:hidden p-3 bg-charcoal-900/80 flex flex-col gap-2.5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="relative w-9 h-9 rounded overflow-hidden border border-myth-cyan/60 bg-charcoal-950 flex-shrink-0 shadow-[0_0_10px_rgba(0,217,255,0.2)]">
                    <Image
                  ...
                  <div>
                    ...
                    <span className="text-[9px] font-mono text-myth-cyan tracking-wider uppercase">
                      LISTENING // ACTIVE
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 text-[9px] font-mono text-text-muted uppercase">
                  <span className="text-myth-cyan font-semibold">SIGNAL:</span>
                  <div className="flex items-end gap-0.5 h-2.5">
                    <span className="w-0.5 h-1 bg-myth-cyan rounded-sm" />
                    <span className="w-0.5 h-1.5 bg-myth-cyan rounded-sm" />
                    <span className="w-0.5 h-2 bg-myth-cyan rounded-sm" />
                    <span className="w-0.5 h-2 bg-myth-red-bright rounded-sm" />
                    <span className="w-0.5 h-2.5 bg-myth-red-bright rounded-sm" />
                  </div>
                </div>
              </div>

              {/* Mobile Action Tags */}
              <div className="flex items-center gap-1.5 overflow-x-auto pb-0.5 text-[9px] font-mono tracking-wider uppercase">
                <span className="px-2 py-1 rounded bg-myth-red/20 border border-myth-red text-myth-red-bright font-bold flex-shrink-0">
                  ● LISTEN
                </span>
                <span className="px-2 py-1 rounded bg-charcoal-950/60 border border-charcoal-800 text-text-muted flex-shrink-0">
                  UNDERSTAND
                </span>
                <span className="px-2 py-1 rounded bg-charcoal-950/60 border border-charcoal-800 text-text-muted flex-shrink-0">
                  STAND
            ...
            {/* LEFT COLUMN: THE MYTH PROFILE & ACTIONS (Desktop Only) */}
            <div className="hidden lg:flex lg:col-span-3 p-4 sm:p-5 bg-charcoal-900/60 flex-col justify-between space-y-6">
            ...
            <div className="lg:col-span-6 flex flex-col justify-between bg-charcoal-950/90 relative">
              ...
              {submissionFailed && (
                <div className="bg-myth-red/20 border-b border-myth-red-bright/50 p-3 sm:p-3.5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-left z-20">
                  <div className="flex items-start sm:items-center gap-2.5">
                    <AlertTriangle className="w-4 h-4 text-myth-red-bright flex-shrink-0 mt-0.5 sm:mt-0" />
                    <div>
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded bg-myth-red hover:bg-myth-red-bright text-white text-[11px] font-mono font-bold uppercase tracking-wider flex items-center gap-1.5 border border-myth-red-bright/60 shadow-sm flex-shrink-0 disabled:opacity-50 active:scale-95"
                  >
            ...
            <div className="lg:col-span-3 p-3.5 sm:p-5 bg-charcoal-900/60 flex flex-col justify-between space-y-4 lg:space-y-6">
              <div className="space-y-4 lg:space-y-6">
                {/* Circular Radar HUD Graphic */}
                <div className="flex justify-center pt-1 sm:pt-2">
                  <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full border border-myth-cyan/40 bg-charcoal-950 flex items-center justify-center overflow-hidden shadow-[0_0_20px_rgba(0,217,255,0.15)]">
                    {/* Concentric radar rings */}
                    <div className="absolute w-14 h-14 sm:w-16 sm:h-16 rounded-full border border-myth-cyan/30" />
                    <div className="absolute w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-myth-cyan/20" />
                    <div className="absolute w-full h-[1px] bg-myth-cyan/20" />
                    <div className="absolute h-full w-[1px] bg-myth-cyan/20" />
                    
                    {/* Sweeping Radar Line */}
                    <div
                      className="absolute w-10 h-10 sm:w-12 sm:h-12 top-0 right-0 origin-bottom-left bg-gradient-to-tr from-transparent to-myth-cyan/30 animate-spin"
                ...
                {/* Telemetry Metrics: 4-Col Grid on Mobile, Stacked on Desktop */}
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-1 gap-2.5 sm:gap-3 lg:space-y-3.5 lg:gap-0 pt-1">
                  <div className="bg-charcoal-950/60 p-2 sm:p-2.5 rounded border border-charcoal-800 lg:bg-transparent lg:p-0 lg:border-0">
                    <div className="text-[9px] sm:text-[10px] font-mono text-text-muted tracking-widest uppercase">
                      FREQUENCY
                    </div>
                  ...
                  <div className="bg-charcoal-950/60 p-2 sm:p-2.5 rounded border border-charcoal-800 lg:bg-transparent lg:p-0 lg:border-0">
                    ...
                    <div className="text-[11px] sm:text-xs font-mono font-bold text-myth-cyan uppercase tracking-wider">
                      LISTENING
                    </div>
                  </div>
              ...
              <div className="pt-3 sm:pt-4 border-t border-charcoal-800 text-[10px] font-mono text-text-muted uppercase text-center lg:text-left">
