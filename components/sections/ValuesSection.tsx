        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
          {pillars.map((pillar) => {
            ...
            return (
              <div
                key={pillar.id}
                className="flex items-center gap-4 sm:gap-5 text-left group p-3 rounded-lg hover:bg-charcoal-900/40 transition-colors"
              >
                ...
                <div className="relative w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0">
                  ...
                  <div className="w-full h-full rounded-full bg-charcoal-900 flex items-center justify-center shadow-[0_0_20px_rgba(193,18,31,0.3)] group-hover:shadow-[0_0_30px_rgba(255,31,45,0.6)] transition-shadow">
                    <Icon className="w-6 h-6 sm:w-7 sm:h-7 text-myth-red-bright group-hover:scale-110 transition-transform" />
                  </div>
                </div>

                {/* Content */}
                <div className="space-y-1">
                  <h3 className="font-mono font-bold text-sm sm:text-base text-white tracking-widest uppercase group-hover:text-myth-cyan transition-colors">
                    {pillar.title}
                  </h3>
