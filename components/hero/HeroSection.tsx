...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[92vh] lg:min-h-screen w-full flex items-center justify-center overflow-hidden bg-charcoal-950 pt-20 pb-16">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        >
          <Image
            ...
            priority
            sizes="100vw"
            className="object-cover object-right sm:object-[center_right] lg:object-right filter brightness-105 contrast-102"
          />
      ...
      <div className="absolute top-1/4 left-1/3 w-[550px] h-[550px] bg-myth-red/15 rounded-full blur-[160px] pointer-events-none animate-pulse-slow" />
      <div className="absolute top-1/3 right-1/4 w-[450px] h-[450px] bg-myth-cyan/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[calc(100vh-140px)]">
          ...
          <motion.div
            ...
            className="lg:col-span-7 flex flex-col justify-center text-left space-y-6 pt-6 lg:pt-0"
          >
            {/* Eyebrow */}
            <div className="text-[11px] sm:text-xs font-mono tracking-[0.25em] text-text-muted uppercase flex items-center gap-2">
              <span>PEOPLE</span>
            ...
            <div className="space-y-1">
              <h1 className="font-display font-black text-6xl sm:text-7xl md:text-8xl lg:text-9xl tracking-tighter text-white leading-[0.88] uppercase select-none drop-shadow-[0_10px_25px_rgba(0,0,0,0.9)]">
                THE
                <br />
            ...
            <div className="space-y-3">
              <h2 className="font-mono font-bold text-sm sm:text-base md:text-lg tracking-[0.18em] text-white uppercase leading-snug drop-shadow-md">
                THE ONE WHO LISTENS
                <br />
                WHEN OTHERS DON&apos;T.
              </h2>

              <p className="text-sm sm:text-base text-text-muted font-sans font-normal max-w-lg leading-relaxed drop-shadow">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <a
                ...
                className="relative group inline-flex items-center justify-center gap-2.5 px-8 py-4 text-xs sm:text-sm font-mono font-bold tracking-wider uppercase text-white bg-myth-red hover:bg-myth-red-bright rounded border border-myth-red-bright/70 shadow-[0_0_25px_rgba(193,18,31,0.65)] hover:shadow-[0_0_45px_rgba(255,31,45,0.95)] transition-all duration-300 active:scale-95 cursor-pointer"
              >
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-charcoal-700/60 max-w-lg">
              <div className="border-l-2 border-myth-red pl-3 space-y-0.5">
                <div className="text-xs sm:text-sm font-mono font-black text-white tracking-wider uppercase">
                  REAL PEOPLE
                </div>
                <div className="text-[10px] sm:text-xs font-mono text-text-muted uppercase">
                  YOU SPEAK
                </div>
              </div>

              <div className="border-l-2 border-charcoal-600 pl-3 space-y-0.5">
                <div className="text-xs sm:text-sm font-mono font-black text-white tracking-wider uppercase">
                  REAL STORIES
                </div>
                <div className="text-[10px] sm:text-xs font-mono text-text-muted uppercase">
              ...
              <div className="border-l-2 border-myth-cyan pl-3 space-y-0.5">
                <div className="text-xs sm:text-sm font-mono font-black text-white tracking-wider uppercase">
                  REAL CHANGE
                </div>
                <div className="text-[10px] sm:text-xs font-mono text-text-muted uppercase">
